...
async def main(args: argparse.Namespace) -> None:
    await generate_descriptions(args, klasse_condition="< 6", sys_msg=STANDARD_SYSTEM_PROMPT)


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Write DE/EN animal descriptions from Wikipedia using gpt-5-nano."
    )
