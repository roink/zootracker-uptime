...
def get_animal_detail(
    ...
    return schemas.AnimalDetail(
        ...
        klasse_name_de=animal.klasse_name.name_de if animal.klasse_name else None,
        klasse_name_en=animal.klasse_name.name_en if animal.klasse_name else None,
        ordnung_name_de=animal.ordnung_name.name_de if animal.ordnung_name else None,
        ordnung_name_en=animal.ordnung_name.name_en if animal.ordnung_name else None,
        familie_name_de=animal.familie_name.name_de if animal.familie_name else None,
        familie_name_en=animal.familie_name.name_en if animal.familie_name else None,
