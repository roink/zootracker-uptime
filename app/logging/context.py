...
client_ip_ctx_var: ContextVar[Optional[str]] = ContextVar("client_ip", default=None)
client_ip_raw_ctx_var: ContextVar[Optional[str]] = ContextVar("client_ip_raw", default=None)
client_ip_anonymized_ctx_var: ContextVar[Optional[str]] = ContextVar(
...
class RequestContextTokens:
    ...
    user_id_token: Token[Optional[str]]
    client_ip_token: Token[Optional[str]]
    client_ip_raw_token: Token[Optional[str]]
    client_ip_anonymized_token: Token[Optional[str]]
...
def bind_request_context(
    ...
    *,
    client_ip_raw: Optional[str] = None,
